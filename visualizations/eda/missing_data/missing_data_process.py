"""
operation_conditions_missing_data.py
------------------------------------

Bu kod, adsorpsiyon proses koşullarına ait verilerdeki eksik değerleri
...
yatay bar grafiği şeklinde gösterilir. 

Çıktı:
- Grafik: "Adsorpsiyon proses koşulları için eksik veri (%)"
- Kaydedilen dosya: ./figures/operation_conditions_missing_data.png
...
bars = ax.barh(y, missing_pct.values, color="#FECB04")

# Başlık ve eksen etiketleri
ax.set_title("Adsorpsiyon proses koşulları için eksik veri (%)", fontsize=11)
...
# Alt klasör: missing_data_figures
save_dir = current_dir / "figures"
save_dir.mkdir(parents=True, exist_ok=True)

# Dosyayı kaydet
fig_path = save_dir / "missing_data_operating_conditions.png"
